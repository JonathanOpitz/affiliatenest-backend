const express = require('express');
   ...
   app.use(cors({
     origin: ['http://localhost:3000', 'https://affiliatenest-backend.herokuapp.com', 'https://affiliatenest-dggekkgul-jonathans-projects-3fae278e.vercel.app'],
     credentials: true,
   ...
   app.use((req, res, next) => {
     res.setHeader('X-App-Version', '1.0.17');
     next();
   });
